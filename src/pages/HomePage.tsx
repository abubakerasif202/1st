...
export default function HomePage() {
  return <>
    ...
    <section className="lovable-hero" aria-labelledby="home-hero-title">
      <img className="lovable-hero__image" src="/images/replacement/actros-mountains-branded.png" alt="1st Class Express branded prime mover travelling on an Australian highway" width="1536" height="1024" loading="eager" decoding="async"/>

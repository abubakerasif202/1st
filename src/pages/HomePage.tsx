...
export default function HomePage() {
  return <>
    ...
    <section className="lovable-hero" aria-labelledby="home-hero-title">
      <img className="lovable-hero__image" src="/images/replacement/prime-mover-network-hero.webp" alt="1st Class Express branded prime mover on an Australian highway with an overlaid map of interstate freight routes connecting major Australian cities" width="1672" height="941" loading="eager" decoding="async" {...{ fetchpriority: 'high' }}/>

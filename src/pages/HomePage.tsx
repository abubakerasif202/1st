...
export default function HomePage() {
  return <>
    ...
    <section className="lovable-hero" aria-labelledby="home-hero-title">
      <img className="lovable-hero__image" src="/images/replacement/prime-mover-hero-branded.png" alt="1st Class Express branded prime mover travelling on an Australian highway" width="1376" height="768" loading="eager" decoding="async"/>

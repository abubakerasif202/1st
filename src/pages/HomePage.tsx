...
export default function HomePage() {
  return <>
    ...
    <section className="lovable-hero" aria-labelledby="home-hero-title">
      <img className="lovable-hero__image" src="/images/lovable/hero-b-double.webp" alt="Black B-double prime mover travelling on an Australian highway at sunset" width="1536" height="1024" loading="eager" decoding="async"/>

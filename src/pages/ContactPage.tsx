...
export default function ContactPage() { return <>
  ...
  <PageHero eyebrow="Contact" title="Let's Get Your Freight Moving" intro="Speak with our transport team about a new movement, an ongoing route or the support your operation needs." image="/images/lovable/logistics-office.jpg"/>

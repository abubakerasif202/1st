...
export default function AboutPage() { return <>
  ...
  <PageHero eyebrow="About Us" title="Australian Owned. Freight Focused." intro="We combine practical transport planning, experienced people and responsive communication to move freight properly." image="/images/replacement/warehouse-loading-branded.png"/>

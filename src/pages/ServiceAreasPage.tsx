...
export default function ServiceAreasPage(){ return <>
  ...
  <section className="lovable-section lovable-section--dark"><div className="container-page"><div className="lovable-heading"><p className="lovable-kicker">Our Network</p><h2>Australia-Wide Interstate Transport</h2><p>1st Class Express supports planned interstate freight from Sydney to Canberra, Melbourne and Brisbane, with Adelaide and Perth movements assessed for each booking.</p></div><div className="route-map-visual"><img src="/images/replacement/australia-network-map.webp" alt="Map of Australia illustrating 1st Class Express interstate freight coverage from Sydney to Canberra, Melbourne, Brisbane, Adelaide and Perth" loading="lazy" width="1672" height="941"/></div></div></section>

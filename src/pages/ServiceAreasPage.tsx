...
export default function ServiceAreasPage(){ return <>
  ...
  <PageHero eyebrow="Service Areas" title="Metropolitan, Regional And Interstate" intro="Local knowledge across Sydney and New South Wales, backed by planned linehaul services between major Australian destinations." image="/images/lovable/prime-mover.jpg"/>

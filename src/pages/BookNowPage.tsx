...
export default function BookNowPage() { return <>
  ...
  <PageHero eyebrow="Request A Quote" title="Tell Us What Needs Moving" intro="Share the freight, route and timing details. Our operations team will review the job and respond with the next step." image="/images/replacement/delivery-fleet-sydney-branded.png"/>

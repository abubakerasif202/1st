...
export function RouteMap() {
  return <div className="route-map"><div className="route-photo">
    <img src="/images/generated/services-collage-branded.jpg" loading="lazy" width="1536" height="1024" alt="1st Class Express nationwide service and fleet capability presentation" />
    <img className="vehicle-brand-mark" src="/brand/first-class-express-logo.png" loading="lazy" alt="" width="90" height="98" />

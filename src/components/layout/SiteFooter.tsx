...
export function SiteFooter() {
  return <footer className="site-footer"><div className="container-page footer-grid">
    <div className="footer-brand"><img src="/brand/first-class-express-logo.webp" loading="lazy" alt="1st Class Express" width="170" height="185"/><p>Committed to Delivering a Quality Service. Australian privately owned transport, linehaul and logistics.</p><p><MapPin size={16}/>Servicing NSW, ACT and interstate routes</p></div>

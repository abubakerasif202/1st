...
export function SiteFooter() {
  return <footer className="site-footer"><div className="container-page footer-grid">
    ...
    <div><h3>Contact</h3><a href={phoneHref(company.phonePrimary)}><Phone size={16}/>{company.phonePrimary}</a><a href={`mailto:${company.email}`}><Mail size={16}/>{company.email}</a><span><MapPin size={16}/>Australia-wide service</span></div>

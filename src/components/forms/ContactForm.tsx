...
import { contactSchema, type ContactValues } from '../../features/enquiry/schema'
...
export function ContactForm({ compact = false }: { compact?: boolean }) {
  ...
  const { register, handleSubmit, formState: { errors, isSubmitting } } = useForm<Values>({ resolver: zodResolver(contactSchema), defaultValues: { name: '', email: '', phone: '', message: '', website: '' } })
